...
import samplePicture from "./gradient.JPG";
...
class RightToolBar extends Component {
  ...
  render() {
      ...
      inputs = (
        <React.Fragment>
          ...
          <Input
            ...
            defaultValue={
              this.props.stage.findOne("." + this.props.selectedName).attrs
                .fontSize
            }
            onBlur={event => {
    ...
    return (
      <React.Fragment>
        <Segment.Group id="collapsedSegment" className="collapsedSegment">
          <Segment
            style={{
        ...
        <div
          ...
          className={this.state.collapsed ? "uncollapsed" : "collapsed"}
          ref={() => {
            this.top =
              document
          ...
          onClick={() => {
            const collapsed = document.getElementById("collapsedSegment");
