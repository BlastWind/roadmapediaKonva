        ...
        {this.props.layer ? (
          <React.Fragment>
            ...
            <Arrow
              ...
              onDragMove={() => {
                var pos = this.props.layer.getStage().getPointerPosition();
                var shape = this.props.layer.getIntersection(pos);

                //after first frame
                if (this.state.previousShape !== undefined  && this.state.previousShape !== null)
                  if (this.state.previousShape !== shape) {
                    ...
                    if (
                      ...
                      !this.state.previousShape.attrs.name.includes("arrow")
                    ) {
              ...
              onDragEnd={event => {
                ...
                if (
                  this.state.previousShape !== null && this.state.previousShape !== undefined &&
                  this.state.previousShape.attrs.id !== "ContainerRect"
                ) {
